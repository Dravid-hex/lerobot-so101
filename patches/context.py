...
def build_rollout_context(
    ...
    if policy_config.use_peft:
        ...
        # Load saved policy first to get input_features/output_features
        saved_policy = policy_class.from_pretrained(policy_config.pretrained_path)
        if not policy_config.input_features and saved_policy.config.input_features:
            policy_config.input_features = saved_policy.config.input_features
        if not policy_config.output_features and saved_policy.config.output_features:
            policy_config.output_features = saved_policy.config.output_features
        del saved_policy
